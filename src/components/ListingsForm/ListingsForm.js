...
class ListingForm extends React.Component {
  ...
  formSubmit = (e) => {
    ...
    e.preventDefault();
    if (
      newListing.address && newListing.city && newListing.state && newListing.zip && newListing.squareFootage && newListing.price && newListing.numBeds && newListing.numBaths && newListing.description && newListing.estimatedMonthlyMorgage && newListing.lotInAcres && newListing.yearBuilt && newListing.heating && newListing.cooling && newListing.imageUrl) {
